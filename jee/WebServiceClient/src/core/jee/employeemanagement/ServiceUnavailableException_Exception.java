 ...
 * 
 */
@WebFault(name = "ServiceUnavailableException", targetNamespace = "http://employeemanagement.jee.core/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: core.jee.employeemanagement.ServiceUnavailableException
     */
